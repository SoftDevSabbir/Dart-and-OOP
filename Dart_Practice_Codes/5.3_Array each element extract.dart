 main(){
 List<String> arr1 =["ahamed",'Mohammad','Likhon','Emon','Jibon'];
 List<String> arr2 =List.filled(5, "Bangladesh");
 Set<int> arr3 ={1,2,3,4,5,6,7,8};
 ...
 for(int i=0;i<student.length;i++){
  print(arr1[i]);       //## i<arr1.length
   ...
   print(arr3.toList()[i]);     //## i<arr3.length
   ///&& or other same mehood
